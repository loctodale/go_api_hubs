...
const (
	...
	AccountService_VerifyProviderAccount_FullMethodName = "/pb.AccountService/VerifyProviderAccount"
)
...
type AccountServiceClient interface {
	...
	VerifyProviderAccount(ctx context.Context, in *VerifyAccountRequest, opts ...grpc.CallOption) (*BaseResponseMessage, error)
}
...
func (c *accountServiceClient) VerifyProviderAccount(ctx context.Context, in *VerifyAccountRequest, opts ...grpc.CallOption) (*BaseResponseMessage, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BaseResponseMessage)
	err := c.cc.Invoke(ctx, AccountService_VerifyProviderAccount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccountServiceServer interface {
	...
	VerifyProviderAccount(context.Context, *VerifyAccountRequest) (*BaseResponseMessage, error)
...
func (UnimplementedAccountServiceServer) VerifyProviderAccount(context.Context, *VerifyAccountRequest) (*BaseResponseMessage, error) {
...
func _AccountService_VerifyProviderAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VerifyAccountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountServiceServer).VerifyProviderAccount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccountService_VerifyProviderAccount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).VerifyProviderAccount(ctx, req.(*VerifyAccountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AccountService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VerifyProviderAccount",
			Handler:    _AccountService_VerifyProviderAccount_Handler,
		},
	},
...
type PrivateAccountServiceClient interface {
	GetAccount(ctx context.Context, in *GetAccountByIdRequest, opts ...grpc.CallOption) (*Profile, error)
}
...
func (c *privateAccountServiceClient) GetAccount(ctx context.Context, in *GetAccountByIdRequest, opts ...grpc.CallOption) (*Profile, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Profile)
...
type PrivateAccountServiceServer interface {
	GetAccount(context.Context, *GetAccountByIdRequest) (*Profile, error)
...
func (UnimplementedPrivateAccountServiceServer) GetAccount(context.Context, *GetAccountByIdRequest) (*Profile, error) {
...
func _PrivateAccountService_GetAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PrivateAccountServiceServer).GetAccount(ctx, req.(*GetAccountByIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
