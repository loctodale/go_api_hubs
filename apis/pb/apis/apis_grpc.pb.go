...
type ApisKeyServiceClient interface {
	...
	CheckApisKeyIsExisted(ctx context.Context, in *CheckApisKeyIsExistedRequest, opts ...grpc.CallOption) (*CheckApisKeyIsExistedResponse, error)
}
...
func (c *apisKeyServiceClient) CheckApisKeyIsExisted(ctx context.Context, in *CheckApisKeyIsExistedRequest, opts ...grpc.CallOption) (*CheckApisKeyIsExistedResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckApisKeyIsExistedResponse)
	err := c.cc.Invoke(ctx, ApisKeyService_CheckApisKeyIsExisted_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApisKeyServiceServer interface {
	...
	CheckApisKeyIsExisted(context.Context, *CheckApisKeyIsExistedRequest) (*CheckApisKeyIsExistedResponse, error)
...
func (UnimplementedApisKeyServiceServer) CheckApisKeyIsExisted(context.Context, *CheckApisKeyIsExistedRequest) (*CheckApisKeyIsExistedResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckApisKeyIsExisted not implemented")
}
...
func _ApisKeyService_CheckApisKeyIsExisted_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckApisKeyIsExistedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApisKeyServiceServer).CheckApisKeyIsExisted(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApisKeyService_CheckApisKeyIsExisted_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApisKeyServiceServer).CheckApisKeyIsExisted(ctx, req.(*CheckApisKeyIsExistedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ApisKeyService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CheckApisKeyIsExisted",
			Handler:    _ApisKeyService_CheckApisKeyIsExisted_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/apis.proto",
