...
public partial class TenantServiceContext : DbContext
{
    public TenantServiceContext()
    {
    }

    public TenantServiceContext(DbContextOptions<TenantServiceContext> options)
        : base(options)
    {
    }
